...
public interface PetRepository extends JpaRepository<Pet, Long> {
        ...
        @Query("SELECT p FROM Pet p WHERE p.id = :petId AND p.user.id = :userId AND NOT p.deleted")
        Optional<Pet> findByIdAndUser(@Param("petId") Long petId, @Param("userId") Long userId);
